#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# by: {{cookiecutter.full_name}}, 2019.

import json
import os
from {{ cookiecutter.project_slug}} import __PKG_NAME__


{%- set CLASS_NAME = cookiecutter.project_name.title().replace(' ', '-').replace('-', '') %}
...
class {{ CLASS_NAME }}:
    ...
    def __str__(self):
        """
            ...
            executing the {{cookiecutter.project_name}} class.
        """
